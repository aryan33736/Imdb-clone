...
function getMoviesDropDown(searchText) {
  axios
    .get("http://www.omdbapi.com/?apikey=d48a63e2&s=" + searchText)
    .then((response) => {
...
<tr class="drop-row">
<td >        ${movie.Title}</td>
<td >       <a onclick="saveMovie('${movie.imdbID}')" class="btn btn-danger">
<i class="fa fa-heart"></i></a></td>

<td>  <a onclick="movieSelected('${movie.imdbID}')" class="btn btn-warning" href="#">Know More!</a>
</td>
</tr>
...
function getMoviesById(id) {
  axios
    .get("http://www.omdbapi.com/?apikey=d48a63e2&i=" + id)
    .then((response) => {
...
function getMovie() {
  ...
  axios
    .get("http://www.omdbapi.com/?apikey=d48a63e2&i=" + movieId)
    .then((response) => {
      console.log(response);
      let movie = response.data;
